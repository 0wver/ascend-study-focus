export interface Habit {
  ...
  parentId?: string; // ID of the parent habit if this is a sub-habit
  isSubHabit?: boolean; // Flag indicating if this is a sub-habit
  subHabits?: string[]; // Array of IDs of child habits
}
...
export interface HabitCompletion {
  ...
  subHabitId?: string; // ID of the sub-habit if completion is for a sub-habit
}
